...
<div class="privacy-text">
	<p><i>Your use of automated bank account feeds enabled by the Yodlee data gathering service (Yodlee Service) from within the Xero Service (Service) is subject to the following terms. These terms should be read in conjunction with the terms and conditions for your own Internet Banking services.</i></p>
<ol>
