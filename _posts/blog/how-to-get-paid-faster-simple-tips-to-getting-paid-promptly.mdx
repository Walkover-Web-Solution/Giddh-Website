...
<figure class="wp-block-image size-large">![](https://miro.medium.com/max/770/1*mxaMPIqHNlaILWVGuehf1g.jpeg)</figure>You render a service or sell a product to your clients. Then you get paid for the service or product you served. In an overly simplified way, that’s the definition of a business.
...
You need cash *now*. Cash flow is important to every business. As discussed in the post [last week](https://blog.giddh.com/a-beginners-guide-to-working-capital-4aecb7891eba), healthy cash flow is the fuel that keeps a business afloat, breathing and functioning properly.
...
<figure class="wp-block-image size-large">![](https://miro.medium.com/max/825/1*AoRTaSkweedm6ja2ajJMEA.jpeg)</figure>Well, this might sound an obvious one, but often business owners lag behind their own invoicing.
...
<figure class="wp-block-image size-large">![](https://miro.medium.com/max/860/1*XakJFMvWNg6kiEFImJ1XSw.png)</figure>People are more likely to complete a task when it’s glaring and easy. And this applies to get paid and paying back as well.
...
<figure class="wp-block-image size-large">![](https://miro.medium.com/max/660/1*FeBupKNPCNlyIYLH_setgg.png)</figure>Unfortunately, it’s not an ideal world we are living in. The truth of the matter is that invoices can typically take anywhere from two to eight weeks to get paid, and that can be a fairly long wait for a small business — remember, as discussed, it’s all about cash flow. This is why every business owner needs to have a follow-up strategy for their invoices.
