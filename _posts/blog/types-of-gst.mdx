...
type: post
id: 669
thumbnail: ../../uploads/2020/05/Colorful-Goods-or-Services-Header.webp

tag: []
post_format: []
wpmm_postgrid_views:
    - '794'
description: Indian constitution had always been imposing tax from the early days of the year 2000. In the initial days, the citizens of India had
---
...
In this segment, we cover all the 4 [types of GST](https://giddh.com/blog/tags/good-and-service-tax) to help you understand the subtle differences between them:
...
The State Goods and Services Tax \[SGST\] is applicable on intra-state \[within the same state\] transactions. In the case of the intra-state supply of goods and/or services, both [State GST](https://gstcouncil.gov.in/sites/default/files/GStgoodsrates.pdf) and the Central GST are levied. Similar to CGST, even SGST is governed by the State Goods and Services Act, 2017, and the entire revenue earned through SGST is solely claimed by the respective state government.
...
If you’re a new taxpayer, understanding different GST forms and different nuances of [GST return filing](https://giddh.com/gst) can be no less than a nightmare for you. In general, there are different types of GST returns according to the number of [GST forms](https://giddh.com/blog/how-to-use-gst-software-online).
