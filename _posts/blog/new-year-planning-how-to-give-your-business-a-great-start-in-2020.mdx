...
<figure class="wp-block-image size-large">![](https://miro.medium.com/max/880/1*g5EMAF_RGM_YTo_ew7U8gQ.jpeg)</figure>We’re just a month away from Christmas! Which means that we’re just two weeks away from the beginning of a new year. As we inch closer to the mark of this year’s end, I would like to ask you a few questions:
...
<figure class="wp-block-image size-large">![](https://miro.medium.com/max/766/1*_5Kt0mRL8M95jQHmmr0FRw.jpeg)<figcaption>Make sure your goals for 2019 are SMART, which is, Specific, Measurable, Attainable, Relevant and Time-Based.</figcaption></figure>Make sure your goals for 2020 are SMART, which is, Specific, Measurable, Attainable, Relevant and Time-Based.
...
<figure class="wp-block-image size-large is-style-default">![](https://miro.medium.com/max/1126/1*11Y-ZvSzMe-Q0saAosQ3eA.jpeg)<figcaption> Jumping head first to cloud accounting to manage finance will help you save resources and streamline your accounting.</figcaption></figure>Jumping headfirst to cloud accounting to manage finance will help you save resources and streamline your accounting.
...
<figure class="wp-block-image size-large">![](https://miro.medium.com/max/858/1*sgALKw3D9l0ISSGkzNB6CQ.jpeg)<figcaption>**Content is truly the king when it comes to marketing in the 21st century.**</figcaption></figure>Content is truly the king when it comes to marketing in the 21st century.  
...
<figure class="wp-block-image size-large">![](https://miro.medium.com/max/825/1*KSHEnOR8neryHsPUYRnodA.png)<figcaption>**“You cannot connect the dots by only looking forward.”- Steve Jobs**</figcaption></figure>> “You cannot connect the dots by only looking forward.”- Steve Jobs
