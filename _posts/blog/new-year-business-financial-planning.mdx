...
status: publish
slug: new-year-business-financial-planning
author: Giddh
excerpt: ''
type: post
id: 49
thumbnail: ../../uploads/2019/11/Gst-return-file.webp
...
wpmm_postgrid_views:
    - 1522
description: For your small business, ending the year the right way can set you up for success come the new year. Use this guide to clean
---
...
<img class="wp-block-image size-large" src = "../../img/blog/1_g5EMAF_RGM_YTo_ew7U8gQ.webp" alt="New year planning How to give your business a great start in 2020" /> We’re just a month away from Christmas! Which means that we’re just two weeks away from the beginning of a new year. As we inch closer to the mark of this year’s end, I would like to ask you a few questions:
...
<img class="wp-block-image size-large" src = "../../img/blog/1__5Kt0mRL8M95jQHmmr0FRw.webp" alt="Set your SMART goals for 2020" /> Make sure your goals for 2019 are SMART, which is, Specific, Measurable, Attainable, Relevant and Time-Based.Make sure your goals for 2020 are SMART, which is, Specific, Measurable, Attainable, Relevant and Time-Based.
...
<img class="wp-block-image size-large is-style-default" src ="../../img/blog/1_11Y-ZvSzMe-Q0saAosQ3eA.webp" alt="Go all-in on the cloud" /> Jumping head first to cloud accounting to manage finance will help you save resources and streamline your accounting. Jumping headfirst to cloud accounting to manage finance will help you save resources and streamline your accounting.
...
The [problem with traditional accounting](https://giddh.com/blog/replace-spreadsheets-with-accounting-software) whether managed offline or on Excel is that the financial data stays unorganized to a greater extent.

[Cloud accounting software](https://giddh.com/blog/replace-spreadsheets-with-accounting-software) solves this issue by offering a centralized space where all your financial data — from your reports to your invoices to your bank transactions — is updated in real time and stored in an organized fashion.
...
<img class="wp-block-image size-large" src ="../../img/blog/1_sgALKw3D9l0ISSGkzNB6CQ.webp" alt="Freshen up your brand’s marketing" />**Content is truly the king when it comes to marketing in the 21st century.**Content is truly the king when it comes to marketing in the 21st century.  
...
<img class="wp-block-image size-large" src = "../../img/blog/1_KSHEnOR8neryHsPUYRnodA.webp" alt="Learn From Your Mistakes" />**“You cannot connect the dots by only looking forward.”- Steve Jobs** “You cannot connect the dots by only looking forward.”- Steve Jobs
...
According to a haunting statistic, over [50% of small businesses fail](https://www.outboundengine.com/blog/scary-surprising-small-business-stats/) within the first four years.
