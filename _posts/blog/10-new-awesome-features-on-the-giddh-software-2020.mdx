...
status: publish
permalink: /10-new-awesme-features-on-the-giddh-software-2020
author: Giddh
excerpt: ''
type: post
id: 47
...
<div class="wp-block-group"><div class="wp-block-group__inner-container is-layout-flow wp-block-group-is-layout-flow">*2019 was an exciting year for Giddh! Here’s looking back at some of the new features that we added to our online accounting software.*

</div></div>At Giddh, we grow by listening to our customers. We gather feedback from hundreds of small business owners and accountants like you, to improve our software and help you achieve more.
...
<figure class="wp-block-image size-large">![](https://miro.medium.com/max/902/1*08ne03zXauel3MVZy6RlmQ.png)</figure>At Giddh, we’re always listening to the feedback of hundreds of small business owners and accountants in order to improve add new features to our platform to help them with their accounting
...
<figure class="wp-block-image size-large">![](https://miro.medium.com/max/1344/1*D4ptYrlgSWNAfrqaxka71A.png)</figure>With direct GST filing our customers can submit their GSTR-1,2,3B and 9 returns directly to the Government portal without the hassle of going through the process of preparing the report and then uploading it on the portal. Giddh does the heavy lifting of preparing an error-free GST report automatically so that you stay GST compliant on time, every time without hassles.

 2) E-commerce integration 
---------------------------

<figure class="wp-block-image size-large">![](https://miro.medium.com/max/1503/1*evOrqlAeA2ZJPodFnCrddg.png)</figure>Whether you’re selling on Amazon or Zencommerce, Giddh integration can help automate your accounting. By integrating Giddh to your favorite e-commerce platform, invoices will be generated automatically whenever an order is placed and an entry will be made against it.

3) Bank Link
------------

<figure class="wp-block-image size-large">![](https://miro.medium.com/max/1331/1*Mt0sIoiCHlKBOZ3fVBj3zQ.png)</figure>Giddh bank-link gives you an up to date overview on the most important asset of your business — cash. Giddh [connects to your bank account](https://giddh.com/conect-bank-reconcile.php) and automatically imports your expenses every day. By connecting your bank account to Giddh you can actively monitor your day to day transactions and reconcile your books.
...
With [Giddh multi-currency accounting](https://giddh.com/multi-currency-accounting-software.php), you can accept payments &amp; send invoices to international customers in the currency you deal in and your customer’s base currency.

5) New Invoice Templates
------------------------

<figure class="wp-block-image size-large">![](https://miro.medium.com/max/1344/1*pyMNObklIE7My1yEoM34ag.png)</figure>At Giddh, we know your business is unique and so are its invoicing needs.

To serve those special needs, we have refreshed our [invoicing platform](https://giddh.com/invoice-software.php) and added several new templates which will make your invoices look beautiful and professional than ever.
...
<figure class="wp-block-image size-large">![](https://miro.medium.com/max/666/1*bLQpGews2OKfJYlh0SwWIQ.png)</figure>Being able to find exactly what you’re looking for is a wonderful thing. Being able to do so faster, is priceless. With Giddh search, you can search for and land on any module, page or account instantly.
...
<figure class="wp-block-image size-large">![](https://miro.medium.com/max/1582/1*aZbmiBhocv2uPMIX_ZSfqg.png)</figure> We introduced new Sales Report that can help you gauge the efficiency of your sales team and monitor your sales trends for a particular quarter or month of a year. Additionally, you can also stay updated about the number of new clients you had business with and the number of invoices you received from them.

8) Aging Report
---------------

<figure class="wp-block-image size-large">![](https://miro.medium.com/max/1339/1*uLXNb9f61vHqoJZ8MhVP9g.png)</figure>We integrated Aging Report with our Contact Management for you to plan and predict cash flow better.
...
<figure class="wp-block-image size-large">![](https://miro.medium.com/max/1584/1*lwjg9_vBdQCjqlJY0sFfkQ.png)</figure>We introduced [Giddh import](https://giddh.com/import-data.php) and export feature for our customers who want to bring in or back up streams of data of every single accounting category in Giddh. Our customers can now import and download their crucial financial accounting figures including their accounts, groups, trial balance, entries, and even inventory.

10) Contact Management
----------------------

<figure class="wp-block-image size-large">![](https://miro.medium.com/max/1335/1*9X3m47c55Cz71BDempbwkQ.png)</figure>Contacts give you a single screen view of all your customers and vendors along with the business history you share with them. Contacts help you be informed about the customers you have in a particular city or region, helping you assess your customer base and create a more targeted sales or marketing effort.

11) Multi-branch accounting
---------------------------

<figure class="wp-block-image size-large">![](https://miro.medium.com/max/1503/1*AeIqg0zpB48E02imhInbvw.png)</figure>Multi-branch accounting Serves you with consolidated financial reports such as balance sheet, income statements of your business spread over multiple branches. Multi-branch accounting is especially helpful in a branch by branch comparison so that you are on top of each branch’s performance.
