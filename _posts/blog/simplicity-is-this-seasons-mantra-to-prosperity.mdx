...
wpmm_postgrid_views:
    - '563'
description: In today’s age of transparency where the new age generation
---
<img class="wp-block-image size-large" src = "https://miro.medium.com/max/900/0*4wYF_L1YotyW0MjH.jpg" /> **How about solving:** **(z2-z3) ^2 = 4(z3-z1) (z1-z2) sin^2 alpha/2**
> 
