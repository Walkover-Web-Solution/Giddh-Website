...
wpmm_postgrid_views:
    - '770'
coverImage : <img class="wp-block-image size-large" src = "../../img/blog/1_RSVTlNBAaolBKNdKZIq1YA.webp" alt="Why accounting software is NOT a threat but your best business decision today?" />
