...
<figure class="wp-block-image size-large">![](https://miro.medium.com/max/1100/1*vtlcZP9KBNAgiZmHcMpsZg.png)</figure>Ever been in a position where you don’t have money to pay creditors or employees? Started a large project, only to find that you don’t have to money to see it through?
...
<figure class="wp-block-image size-large">![](https://miro.medium.com/max/1126/1*-tUj4wgTp_UkYjcLLokgRQ.jpeg)</figure>Here are some examples of items that fall under the category of current assets:
...
<figure class="wp-block-image size-large">![](https://miro.medium.com/max/660/1*RSNLRFxvrvv_9avxah6BUA.jpeg)</figure>Working capital keeps the business operations moving. It is needed to purchase raw materials, to pay the workers and staff and also to pay the recurring expenses like electricity and power bills, rent, etc.
...
<div class="wp-block-media-text alignwide is-vertically-aligned-top">![](../../uploads/2019/11/1_sb54-yfSuzZ6eWUxuNqFIw.jpeg)<div class="wp-block-media-text__content">Apply transparency and clarity when it comes to how much you spend. This begins with examining your budget and breaking it down to its components. Make sure you’re not overspending in any area of your business. Set rules to restrict any unnecessary spending.
...
</div></div> ****Use Up-to-date Financial Information****
---------------------------------------------

<figure class="wp-block-image size-large">![](https://miro.medium.com/max/726/1*nigDEH8IGMjsaKYNKgUzMw.jpeg)</figure>The way to make sure that working capital is managed is to use key performance indicators (KPIs).
