...
wpmm_postgrid_views:
    - '1103'
---
<figure class="wp-block-image size-large">![](https://miro.medium.com/max/517/0*MPQQe-xlwsHq1Bf-.jpg)</figure>Remember the time when accountants had to manually feed in the logs and keep track of all the transactions of the organization to avoid tax and other compliance issues? Yes, it was no less than manual labor. However, over the years, the [**role of an accountant**](https://giddh.com/guide/life-saving-hacks-for-accountants-and-bookkeepers-in-2020/) took a drastic leap owing to technological advancements.
...
<figure class="wp-block-image size-large">![](https://miro.medium.com/max/521/0*8wu59zD6NqWabTVY.jpg)</figure>#### Managerial role
