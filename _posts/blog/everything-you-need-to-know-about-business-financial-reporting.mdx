...
<img class="wp-block-image size-large" src = "https://miro.medium.com/max/990/1*nwQT6vSpCRZF_UXylGI7HA.png" />Let’s first establish the premise about what [cloud](http://giddh.com/) is all about.
