...
wpmm_postgrid_views:
    - '742'
coverImage : <img class="wp-block-image size-large" src = "../../img/blog/1_Nia334LHDSNzqJruAyxi-Q.webp" alt="Running in loss? Here’s how to reverse it!" />
...
<img class="wp-block-image size-large" src = "../../img/blog/1_Nia334LHDSNzqJruAyxi-Q.webp" alt="Running in loss? Here’s how to reverse it!" />**2.** **Reducing expenditure**
-------------------------------
