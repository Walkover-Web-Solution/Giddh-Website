...
type: post
id: 735
thumbnail: ../../uploads/2020/06/GST-Return-Featured-2.jpg
category:
    - General
tag: []
post_format: []
wpmm_postgrid_views:
    - '1213'
description: As the Covid-19 pandemic brings the world to a halt,
---
<img src ="../../uploads/2020/06/GST-Return.jpg" /> As the Covid-19 pandemic brings the world to a halt, businesses are trying their best to cope up with the economic impacts of the virus. Taking everything into consideration, the government recently announced that the [GST return](https://giddh.com/guide/complete-guide-to-gst/) filing will be extended for March, April and May to provide relief to businesses.
...
Overwhelmed by [GST return dates](https://giddh.com/guide/complete-guide-to-gst/)? If you are wondering how to [file GST returns](https://giddh.com/gst/) or how many you have to file, here’s a refresher to help you out.

**Who should file GST returns?**
--------------------------------

Business owners and dealers who are registered under the GST system are liable to file their GST returns depending on their business and transactions. The [types of GST returns](https://giddh.com/guide/complete-guide-to-gst/) are mentioned below.
