...
<img class="wp-block-image size-large" src = "../../img/blog/1_Xg2nUvXappjm_m3rNmJZ0A.webp" alt="Finance basics How to forecast growth?" />**Get total headcount per client**
