...
wpmm_postgrid_views:
    - '969'
coverImage : <img class="wp-block-image size-large" src = "../../img/blog/1_Axh_bthyOdCmbqvzAlHxRQ.webp" alt="Cloud Accounting — Myth vs Reality" />
...
If you have worked on and used offline accounting software Tally and have your accounting data on that platform, [you can bring that data](https://giddh.com/help/sync-with-tally-1591360375828781) on cloud software like Giddh.
...
Today, more than 40% of SMMs have started using online accounting solutions. In case you are doubtful, just think about simple cloud applications you have been using all along — Gmail, Google Drive, Skype, OneDrive etc. All these are cloud-based services. And a [small business owner](https://giddh.com/blog/online-accounting-benefits-for-small-business) would benefit more from a cloud accounting solution since it is easily scalable as a business grows.
...
<img class="wp-block-image size-large" src = "../../img/blog/1_IE3SJnLVGpFLzHY83POGpQ.webp" alt="Cloud Accounting — Myth vs Reality" />When a business owner or an accountant uses offline accounting software, it leaves them vulnerable to unethical network hampering such as phishing and hacking.
...
What are your thoughts on cloud accounting? Just comment below or [read this space](https://giddh.com/blog) for more informative stuff.