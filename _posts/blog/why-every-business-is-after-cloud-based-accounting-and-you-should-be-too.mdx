...
wpmm_postgrid_views:
    - '785'
coverImage : <img class="wp-block-image size-large" src ="../../img/blog/1_TklL7QYA-HiCjoK7_suS3w.webp" alt="Why every business is after cloud-based accounting (and you should be too)?" />
...
<img class="wp-block-image size-large" src ="../../img/blog/1_TklL7QYA-HiCjoK7_suS3w.webp" alt="Why every business is after cloud-based accounting (and you should be too)?" />**Cloud offers world-class security**
