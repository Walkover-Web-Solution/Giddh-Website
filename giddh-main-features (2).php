...
<div id="filling">
    ...
    <div class="col-md-12 mrB3">
	    	<h1>Write Your Success Story with our Automation!</h1>
            
            <p align="center">As a business ourselves, we recognize how important it is for you to keep your books in great shape. Giddh is an online software that keeps track of your business transactions and organizes your accounting history so that you make smart business decisions.</p>
	    </div>
    	
        <div class="row">
        
        <h2>A  Simpler, Faster and Smarter Way to Accounting.</h2>
        

<h3>Generate Invoices Instantly</h3>

<p>Create professional looking invoices for your clients and run your business on four cylinders by letting Giddh send those invoices automatically. </p>

<h3>Set up Due Dates & Payment Reminders</h3>

<p>No more worrying about unpaid invoices. Set up due date and have Giddh send payment reminders to your clients automatically so that you can get paid faster.
</p>

<h3>Be In Control, Always.</h3>

<p>Give permissions to your accountants to make changes to your accounting history. Revoke the permission once the job is done! With Giddh you are always on the driver's seat</p>

<h3>Track Manufacturing in Real-Time</h3>
<p>Track your manufacturing stock and expenses with Giddh's unique manufacturing analysis tool. Keeping tabs on manufacturing is no more a hassle!</p>

<h3>Add Multiple Branches</h3>
<p>Don't scratch your head in confusion anymore. Analyse expenditure incurring & revenue generating branches with our Multi branch solutions. </p>

<h3>Always on the Go? No problem!</h3>
<p>With Giddh's cloud based approach, you are no longer bound to your desk. Install our app and keep tabs on your accounting, anywhere-anytime!</p>
