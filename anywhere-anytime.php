  ...
  <section id="videoBg" class="pr black-back">
    ...
    <img src="../assets/images/Cloud Icon.svg" alt="" class="sky-one-01">
        <div class="banner_intro features_banner">
              <h1 class="banner_heading">For business owners and accountants who are always on the go</h1>
              <p class="banner_sub_heading m-t-20">Generate invoices, view reports & manage your books wherever you are.</p>
              <p class="m-t-20">
