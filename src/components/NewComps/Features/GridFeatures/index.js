      ...
      <div className="container d-flex flex-column gap-4">
        ...
        <div className="row g-3">
          {features.cards.map((card, index) => (
            ...
            >
              <div className={`d-flex flex-column gap-3 border rounded-4 px-4 py-2 justify-content-center text-center border-color-primary gradient-primary ${styles.card}`}>
