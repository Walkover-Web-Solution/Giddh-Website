        ...
        <>
            <section className="container-fluid client-summary">
                <div className="container">
                    <h2 className="client-summary__title text-center col-primary">Our clients list</h2>
                    <div className="client-summary__content-wrapper">
                        <div className="row row-gap-5 ">
                            {ourClient.map((res) => {
                                return (
                                    <>
                                        <div className="col-lg-3 col-md-6 col-sm-12 column-wrapper">
                                            <a href={res.websiteLink} target="_blank" className="d-block client">
                                                <figure>
                                                    <img src={"/img/our-clients" + res.clientLogo} alt={res.clientName} width="auto" height="60" />
                                                </figure>
                                            </a>
                                        </div>
                                    </>
