          ...
          <div className="row">
            <div className="col-xxl-3 col-lg-4 col-md-6 col-sm-12">
              <div className="feature-gallery__card"> 
                <figure>
                  <img src="/img/feature-gallery-icons/inventory.png" alt="Inventory Icon" />
            ...
            <div className="col-xxl-3 col-lg-4 col-md-6 col-sm-12">
              <div className="feature-gallery__card"> 
                <figure>
                  <img src="/img/feature-gallery-icons/invoice.png" alt="Invoices Icon" />
            ...
            <div className="col-xxl-3 col-lg-4 col-md-6 col-sm-12">
              <div className="feature-gallery__card"> 
                <figure>
                  <img src="/img/feature-gallery-icons/anywhere-anytime.png" alt="Anywhere Anytime Icon" />
            ...
            <div className="col-xxl-3 col-lg-4 col-md-6 col-sm-12">
              <div className="feature-gallery__card"> 
                <a href="#" className="c-fs-3">See More</a>
              </div>
            </div>
          </div>
