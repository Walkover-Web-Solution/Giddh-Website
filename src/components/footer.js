          ...
          <div className="container">
            <div className="row">
                ...
                <div className="d-flex">
                  <div className="d-flex flex-column gap-3 .text-dark">
                    ...
                    <ul className="footer-list list-unstyled mb-3">
                      ...
                      <li >
                        <a target="_blank" rel="noopener" href="">Work With Us</a>
                      </li>
                      <li>
              ...
              <div className=" -sm-12 col-md-3 ">
                <h5 className="list-unstyled d-flex flex-column gap-2">Contact Us</h5>
                <div>
              ...
              <div className="col-sm-12 col-md-3">
                <div className="location">
                  ...
                  <div className="location-detail">
                    <h4 >Indore</h4>
                    <p>
                      Walkover Web Solutions Pvt Ltd.<br /> 405-406, Capt. C.S.
                      Naidu Arcade,<br /> Near Greater Kailash Hospital, 10/2 Old
                      Palasia,<br /> Indore, Madhya Pradesh, India-452018
                    </p>
                  </div>
                  <div className="location-detail">
                    <h4>USA</h4>
                    <p>
                      USA Superheroes, Inc<br /> Sunset Lake Road, Suite B-2<br />{" "}
                      DE - Delaware<br /> United States of America
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="d-flex mt-4 copyright-text">
              <li
                ...
                className="widget_text widget widget_custom_html list-unstyled class"
              >
                <div className="textwidget custom-html-widget ">
