                    ...
                    <div className="row">
                        <div className="col-lg-7 order-lg-0 order-1">
                            ...
                            <p className="col-grey c-fs-3 mb-5">
                                Allow external accountants & internal team members across different departments to work together seamlessly.</p>.
                    ...
                    <div className="row">
                        <div className="col-12 text-center features__sub_heading_container--pull-top">
                            ...
                            <p className="c-fs-4 mb-5">
                                Multi user accounting software enables business owners & accountants to collaborate and make the best of their numbers.
                                With real time sharing of financial data, you can derive meaningful insight and run your business with efficiency.</p>
                        ...
                        <div className="col-12">
                            <div className="accordion" id="accordionAllFeatures">
                                ...
                                <div className="accordion-item">
                                    ...
                                    >
                                        <div className="accordion-body">
                                            The Giddh software is designed in such a way that any person without an accounting experience can operate
