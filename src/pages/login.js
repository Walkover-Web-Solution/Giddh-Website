      ...
      <section className="login d-flex  ">
        <div className="login__left_section col-lg-3 col-md-6">
          <img
            ...
            className="login__left_section__brand_logo"
          />
          <img
            src="/img/login-page-left-section-banner.svg"
            className="login__left_section__banner pe-4 img-fluid"
          />
        </div>
        <div className="login__right_section col-lg-9 col-md-6 col-sm-12 col-12">
          <div className="login__right_section__container">
            ...
            <button className="login__right_section__container__login_button mb-4">
              Login with OTP
            </button>
