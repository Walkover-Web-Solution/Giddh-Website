        ...
        <div className="container mt-5">
          ...
          <div className="row">
            <div className="col">
              <div className="filing-tax-card d-flex flex-column align-items-center gap-4 p-3">
                <img
                  src="/img/tax-images/Direct-Filing.svg"
            ...
            <div className="col">
              ...
              <div className="filing-tax d-flex flex-column align-items-center gap-4 p-3">
                <img
                  src="/img/tax-images/get-notified.svg"
          ...
          <div className="row">
            <div className="col">
              ...
              <div className="filing-tax d-flex flex-column align-items-center gap-4 p-3">
                <img
                  src="/img/tax-images/easy-fast.svg"
            ...
            <div className="col">
              ...
              <div className="filing-tax d-flex flex-column align-items-center gap-4 p-3">
                <img
                  src="/img/tax-images/secure-reliable.svg"
            ...
            <div className="col">
              ...
              <div className="filing-tax d-flex flex-column align-items-center gap-4 p-3">
                <img
                  src="/img/tax-images/best-support.svg"
                  alt="support icon"
                />
                <div className="caption text-center">
                  <h2 className="small-heading col-primary c-fw-600">
      ...
      <section className=" py-4 my-4 mx-2 mx-md-0 ">
        <div className="d-flex flex-column gap-4 c-fs-3 text-center ">
          ...
          <div>
            <a
              href="/ae/signup"
              className="c-fs-4 tax-hero-container__try_now_btn"
            >
              Try Now
            </a>
          </div>
            ...
            <div className="col-md-12 col-lg-6">
              <div className="features__description_container__content">
                ...
                <p>
                  ...
                  for domestic consumption. The VAT is paid by the customers and
                  it’s simultaneously remitted to the government by the business
                  that is selling the services and goods. This means that the
                  money is generated by the consumers
                </p>
                <span
