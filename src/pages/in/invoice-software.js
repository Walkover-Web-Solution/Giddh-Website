  ...
  return (
    <div className="features">
        ...
        <div className="container features__heading_container">
          <div className="row">
            <div className="col-lg-7 order-lg-0 order-1">
              ...
              >
                {isAE &&
                  "UAE-Specific Invoice Software for Business Efficiency"}
          ...
          <div className="row">
            <div className="col-12 text-center features__sub_heading_container--pull-top">
              ...
              <p className="c-fs-4 mb-5">
                With GIDDH, Say Goodbye to Tedious Invoicing! Boost Productivity
                with Online Invoicing Software for Transactions, Gaining a
          ...
          {isGlobal ? (
            <>
              {globalData.map((feature, index) => {
                return (
                  <div
                    className={`row mb-5 pb-5 align-items-center border-bottom features__description_container--row-${
                      index % 2 === 0 ? "even" : "odd"
                    }`}
                  >
                ...
                <div className="row mb-5 pb-5 align-items-center features__description_container--row-odd border-bottom">
                  <div className="col-md-12 col-lg-6">
                    <div className="features__description_container__content">
                      ...
                      <p>
                        Generate hassle-free invoices for international clients
                        by automatically calculating real-time exchange rates.
                        Say goodbye to the tedious task of manually looking up
      ...
      <section
        ...
        aria-labelledby="importance-of-invoices"
      >
            ...
            <div className="col-12">
              <div className="text-center">
                <a
                  href={link + "/signup"}
                  className="btn-link-purple"
                  aria-label="Sign up for Giddh invoicing software"
                >
                  Try Now
                </a>
              </div>
              ...
              <p>
                ...
                business. An invoice is a document that lists down the products
                and services, along with the required prices for the same,
              ...
              <p>
                ...
                rendered and help the businesses get paid. With the present form
                of innovations, most businesses use invoice templates to avoid
                creating invoices from scratch. They not only help you save time
                but also repopulate the same information instead of having to
                fill it from scratch again and again. In case you want an
                invoicing software with more advanced software, you can try out
                Giddh. You can perform all your finance functions such as
                generate invoices online in a matter of minutes.
              </p>
              ...
              <div style={{ display: readMoreStatus ? "block" : "none" }}>
                ...
                <p>
                  ...
                  professional-looking invoices. It’s a fast and easy process of
                  sending and tracking invoices and can help reduce costs and
                  save time.
                </p>
                <p className="c-fw-600 d-inline-block">
                  Let’s look at some of the benefits of &nbsp;{" "}
                  {(isGlobal || isIndia) && " creating online invoices:"}
                </p>
                {isAE && (
                  <>
                    <h2 className="c-fw-600 c-fs-5 d-inline-block">
                      Create Custom Invoices for Your UAE Business
                    </h2>
                    :
                  </>
                )}
                {isUK && (
                  <>
                    <h2 className="c-fw-600 c-fs-5 d-inline-block">
                      Professional Invoice Templates for UK Businesses
                    </h2>
                    :
                  </>
                )}
                ...
                {isAE && (
                  <h2 className="c-fs-5 c-fw-600 mb-3">
                    Streamline Your Billing with VAT Compliance{" "}
                  </h2>
                )}
                {isUK && (
                  <h2 className="c-fs-5 c-fw-600 mb-3">
                    Efficient Invoicing for Faster Payments
                  </h2>
                )}
                <p>
                  <span className="c-fw-600">Speed –</span> With online invoice
                  software, you can create online invoices at lightning speed.
                  If you send out your invoices fast, you can get paid fast as
                  well. When you’re sending out multiple invoices, it may seem
                  like a lengthy and monotonous process of filling out the same
                  details again and again. Since online invoices are
                  cloud-based, you can repopulate the information in as many
                  invoices as required. You can also reduce your hassles by
                  scheduling your invoices at specific dates and times so that
                  they can be sent automatically. It can also reduce your
                  dependency on your accounting personnel as you can directly
                  send the invoice online. Finally, you can access the invoices
                  from anywhere, even if you’re not in the office. Thus, the
                  online invoice software can make your entire invoicing
                  function a great deal faster.
                </p>
                <p>
                  <span className="c-fw-600">Monitoring –</span> It doesn’t just
                  end with sending fast invoices. Following up and checking
                  whether the payment has come in can take up a lot of time as
                  well. This can help you in avoiding missing any due dates. The
                  invoice software can help you check the status of your
                  payments, find out which ones are due and which ones have been
                  resolved to get an overview of the total outstanding payments.
                  Moreover, you can also get personalised reminders for
                  individual clients and invoices so that you’re always up to
                  date. There are also ample reports to choose from to get a
                  clearer understanding of your clients and make payment
                  adjustments for each client accordingly. Finally, you can
                  leave a precise and transparent audit trail so that you can
                  track individual transactions in case of any queries.
                </p>
                <p>
                  ...
                  in doing the task is still there. Using an invoicing software
                  to create invoice online can help you save a lot of time and
                  be good for your pocket as well. It can help you maintain your
                  company cash flow effectively and send invoices to your
                  client, ensuring seamless cash flow management. You can also
                  effectively do away with all the messy paperwork, rather use
                  the templates, customise, and send them within minutes.
                </p>
                <p>
                  <span className="c-fw-600">
                    Automate your invoicing process –
                  </span>{" "}
                  One of the best advantages of online invoice software is that
                  you can automate your entire processes. It also means you can
                  actually set up recurring payments for your long-term clients
                  in the form of a subscription-based model. There can be
                  automatic reminders and follow-ups for both past and future
                  invoices.
                </p>
                <p>
                ...
                <p>
                  ...
                  security protocols matter a lot, especially, when it comes to
                  finances. That’s why it’s best to choose an online invoice
                  software that adheres to all security standards such as the
                  PCI security standards. Environment-friendly – Statistics have
                  discovered that the invoices generated by online invoice
                  software are more environmentally-friendly than traditional
                  paper invoices. It saves energy, water, and paper resources as
                  well as reduces pollution. So, by adopting an e-invoicing
                  system, you may reduce your carbon footprints.
                </p>
              </div>
        ...
        <div className="container">
          <div className="row">
            <div className="col-12 text-center features__sub_heading_container--pull-top">
              ...
              <div
                className="features__suggestion_container__links"
                role="navigation"
