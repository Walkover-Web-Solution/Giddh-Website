                ...
                <div className=" d-flex flex-column flex-md-row gap-2 align-items-center my-3">
                  ...
                  <div className="col-12 col-md-6">
                    ...
                    <p className="c-fs-4">
                      ...
                      track of your success and know which types of promotions are
                      working the best for your audience.
                    </p>
                  </div>
                </div>
              </section>
                ...
                <div className=" d-flex flex-column flex-md-row-reverse gap-2 align-items-center my-3">
                  ...
                  <div className="col-12 col-md-6">
                    ...
                    <p className="c-fs-5 ">
                      ...
                      receive access to a special newsletter with important
                      product updates, news on promotions. Also you will get all
                      details on Cloud based GST software.
                    </p>
                  </div>
                </div>
              </section>
