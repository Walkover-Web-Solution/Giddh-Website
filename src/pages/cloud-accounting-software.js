                    ...
                    <div className="row">
                        <div className="col-lg-7 order-lg-0 order-1">
                            ...
                            <p className="col-grey c-fs-3 mb-5">
                                Generate invoices, view reports & manage your books wherever you are.</p>
                    ...
                    <div className="row">
                        <div className="col-12 text-center features__sub_heading_container--pull-top">
                            ...
                            <p className="c-fs-4 mb-5">
                                All you ever need to be on top of your accounting is just an active internet connection.
                                Conduct your business from anywhere with our online cloud accounting software. Manage inventory,
                                file GST returns, or reconcile your books; the possibilities are truly limitless with Giddh’s cloud
                    ...
                    <div className="row mb-5 pb-5 align-items-center features__description_container--row-odd border-horizontal">
                        <div className="col-md-12 col-lg-6">
                            <div className="features__description_container__content">
                                ...
                                <p className="">
                                    Crunch numbers, reconcile books or send an urgent invoice to customers. With Giddh’s accounting software on cloud,
                                    turn your browser into your office and access all your financial data sitting at your local coffee shop or while
                                    you’re on a commute.
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="row mb-5 pb-5 align-items-center features__description_container--row-odd border-horizontal">
                        <div className="col-md-12 col-lg-6">
                            <div className="features__description_container__content">
                                ...
                                <p className="">
                                    No matter what your business is all about, making money must be your number one priority. By using our online cloud accounting software, you can save money as you would no longer need to worry
                                    about expensive version upgrades, maintenance costs & even the cost of hiring an entire accounting department
                                </p>
                            </div>
                        </div>
                        <div className="col-md-12 col-lg-6 __image-alignment">
                    ...
                    <div className="row mb-5 pb-5 align-items-center features__description_container--row-even">
                        <div className="col-md-12 col-lg-6">
                            <div className="features__description_container__content">
                                ...
                                <p className="">
                                    Most businesses are switching over to online cloud accounting software since
                                    they make business operations and financial information management easier. If you haven’t
                                    yet switched over to accounting software on cloud, then you might want to look at the benefits you may be missing out on:
                                </p>
                            </div>
                        </div>
                        <div className="col-md-12 col-lg-6 __image-alignment">
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-12 text-center features__sub_heading_container--pull-top">
                            ...
                            <p className="c-fs-4 mb-5">
                                Although there exist some of the oldest tallying and accounting software players in the market,
                                with more emerging choices people are opting for modern and advanced software. There are several ways
                                in which Giddh as a cloud accounting software can make a better option:</p>
                        </div>
                    </div>
                </div>
            </section>
                        ...
                        <div className="col-12">
                            <div className="accordion" id="accordionAllFeatures">
                                ...
                                <div className="accordion-item">
                                    ...
                                    >
                                        <div className="accordion-body">
                                            A cloud accounting software isn’t very different from the traditional, locally-hosted software, but it is capable
                                            of handling more complex tasks and is hosted on remote servers or the cloud. Here, the data and the software are
                                            stored on remote servers instead of the user’s desktop, and the user can access it through the internet via a cloud service provider.
                                ...
                                <div className="accordion-item">
                                    ...
                                    >
                                        <div className="accordion-body">
                                            An accounting software can help you carry out financial tasks, such as recording your
                                            company expenses, preparing estimates, creating and sending invoices, filing tax returns,
                                            keeping a record of profit and loss statements, allocating budgets and making forecasts. It can also be used to automate the manual
                                            and repetitive tasks involved in maintaining financial accounts, and save up on significant time and resources.
                                        </div>
                                    </div>
                                </div>
                                {/*============ Accordion #3 ===============*/}
                                <div className="accordion-item">
                                    ...
                                    >
                                        <div className="accordion-body">
                                            As compared to traditional accounting software, cloud-based accounting systems offer better security for your financial information.
                                            All your data is stored on remote servers in an encrypted format. Besides, the best cloud accounting software ensures that critical financial data is not exposed to unauthorised sources and has backup servers to ensure there is zero data loss. With cloud-based accounting software,
                                ...
                                <div className="accordion-item">
                                    ...
                                    >
                                        <div className="accordion-body">
                                            <p> Web-based accounting software allows access to your accounting data through the internet to different users and systems.
                                                Therefore, your data can be accessed by multiple users and multiple devices at the same time. Besides,
                                                you can set the access permission for each user so that you can control which data can be accessed by a particular user. </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="accordion-item">
                                    ...
                                    >
                                        <div className="accordion-body">
                                            <p> Online cloud accounting software offers several advantages over offline solutions, which are described below.</p>
                                            <ul>
                                                <li>
