          ...
          <div className="row">
            <div className="col-lg-7 order-lg-0 order-1">
              ...
              <p className="col-grey c-fs-3 mb-5">
                Generate invoices, view reports & manage your books wherever you
                are.
              </p>
          ...
          <div className="row">
            <div className="col-12 text-center features__sub_heading_container--pull-top">
              ...
              <p className="c-fs-4 mb-5">
                ...
                active internet connection. Conduct your business from anywhere
                with our online cloud accounting software. Manage inventory,
                file GST returns, or reconcile your books; the possibilities are
                truly limitless with Giddh’s cloud accounting software.
              </p>
            ...
            <div className="col-md-12 col-lg-6">
              <div className="features__description_container__content">
                ...
                <p className="">
                  ...
                  accounting software, you can save money as you would no longer
                  need to worry about expensive version upgrades, maintenance
                  costs & even the cost of hiring an entire accounting
                  department
                </p>
              </div>
            </div>
            ...
            <div className="col-md-12 col-lg-6">
              <div className="features__description_container__content">
                ...
                <p className="">
                  ...
                  be on the same page, even when they are not at the same place.
                </p>
              </div>
            </div>
            <div className="col-md-12 col-lg-6 __image-alignment">
            ...
            <div className="col-md-12 col-lg-6">
              <div className="features__description_container__content">
                ...
                <p className="">
                  ...
                  at the major differences between a traditional desktop
                ...
                >
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        Data stored on PC with risk of data loss from disk crash
          ...
          >
            <div className="col-md-12 col-lg-6">
              <div className="features__description_container__content">
                ...
                <p className="">
                  Most businesses are switching over to online cloud accounting
                  software since they make business operations and financial
                  information management easier. If you haven’t yet switched
                  over to accounting software on cloud, then you might want to
                  look at the benefits you may be missing out on:
                </p>
                <span
                  className="pt-3 text-decoration-underline c-fw-500"
                  style={{
              ...
              <div className="features__description_container__content">
                ...
                >
                  <li>
                    ...
                    automation can bring in a welcome change in your functioning
                    and help your employees get more work done and process more
                    data. No more wasting time posting or chasing invoices. With
                    the{" "}
                    <span className="c-fw-600">
                      accounting cloud based software
                    </span>
                    , you can generate automatic invoices. It can also help you
                    to keep track of all your debtors and provide timely
                    reminders to make payments. The software can also help avoid
                    any unnecessary duplications as well as other human errors.
                    Since they are regularly updated automatically, you can
                    expect fast and accurate financial operations without any
                    intervention.
                  </li>
                  <li>
                    ...
                    confidential information. Using backup systems doesn’t help
                    much since they end up creating duplicate versions of files,
                    plus storage costs can be quite cumbersome. With{" "}
                    <span className="c-fw-600">cloud accounting software</span>,
                    the data can be backed up and stored on an offline server.
                    This can immune businesses to losses from virus, theft, or
                    accidents and still help you retain your data.
                  </li>
                  <li>
                    ...
                    can work on a single file without creating multiple versions
                    of it. It also makes user access and login permissions easy
                    so that everyone can access the file without difficulties.
                    It’s also possible to access the data from anywhere and on
                    any device.
                  </li>
                  <li>
                    <span className="c-fw-600">Scalability -</span> One of the
                    best advantages of cloud-based accounting software is that
                    they can be customised to meet the needs of small as well as
                    large businesses. Because of this scalability, you can
                    easily expand the functions of the software to meet the
                    needs of your growing business. It can be adapted to include
                    all the necessary integrations and features you may need
                    along the way.
                  </li>
                  <li>
                    <span className="c-fw-600">Simple to use -</span> Maybe one
                    of the best catches for the software is that it can be
                  ...
                  <li>
                    <span className="c-fw-600">Updated data -</span> One of the
                    benefits that must be highlighted are automatically updated
                    data that can reflect in the business balance sheets in real
                    time. There are also several regularly updated reports that
                    can give you an overview of your finances. It also helps you
                    make better financial decisions.
                  </li>
                  <li>
                    <span className="c-fw-600">Accuracy -</span> Since most of
                    the functions are automated, human errors are reduced to a
                    great extent. This increases the efficiency and accuracy of
                    your business operations. For example, working repeatedly on
                    the same invoices can create human errors sometimes which
                    automated accounting can omit.
                  </li>
                  <li>
                    <span className="c-fw-600">Efficiency -</span> Online cloud
                    accounting software can also help you streamline your
                    finance processes and boost the overall efficiency of your
                    employees. It can also help increase productivity and help
                    employees make the best use of their time and schedules.
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    save a fortune by doing away with the hefty one time fee for
                    accounting software along with the yearly maintenance costs.
                    Paying the monthly subscription fees may be better suits for
                    your pocket. There are also several discounts that come with
                    the subscription.
                  </li>
                </ul>
                <span
            ...
            >
              <ul className="custom-ul-with-right-tick text-start">
                ...
                <li>
                  ...
                  above, Non-cloud based software can only be accessed from the
                  computer or desktop it’s installed in. Giddh’s cloud software,
                  on the other hand, can be accessed from anywhere and on any
                  device.
                </li>
                <li>
                  <span className="c-fw-600">Invoices–</span>Since invoicing is
                  a core part of accounting processes, so a software such as
                  Giddh which helps you customise invoices is better than one
                  which just creates the same ones repetitively. You can also
                  stop worrying about GSTs in your invoices since they’ll be
                  calculated automatically.
                </li>
                <li>
                  <span className="c-fw-600">Customer support</span>You also get
                  the benefit of 24*7 customer support through chat or phone
                  calls for resolving any of your problems. All your doubts are
                  easily solved by experts.
                </li>
                <li>
                ...
                <div className="accordion-item">
                  ...
                  >
                    <div className="accordion-body">
                      A cloud accounting software isn’t very different from the
                      traditional, locally-hosted software, but it is capable of
                      handling more complex tasks and is hosted on remote
                      servers or the cloud. Here, the data and the software are
                      stored on remote servers instead of the user’s desktop,
                      and the user can access it through the internet via a
                ...
                <div className="accordion-item">
                  ...
                  >
                    <div className="accordion-body">
                      ...
                      tasks, such as recording your company expenses, preparing
                      estimates, creating and sending invoices, filing tax
                      returns, keeping a record of profit and loss statements,
                      allocating budgets and making forecasts. It can also be
                      used to automate the manual and repetitive tasks involved
                      in maintaining financial accounts, and save up on
                ...
                <div className="accordion-item">
                  ...
                  >
                    <div className="accordion-body">
                      ...
                      cloud accounting software ensures that critical financial
                      data is not exposed to unauthorised sources and has backup
                      servers to ensure there is zero data loss. With
                      cloud-based accounting software, it is safe and easy to
                      share data as well. You can just grant access rights to
                      the person you want to share your data with.
                    </div>
                  </div>
                </div>
                {/*============ Accordion #4 ===============*/}
                  ...
                  >
                    <div className="accordion-body">
                      <p>
                        ...
                        accounting data through the internet to different users
                        and systems. Therefore, your data can be accessed by
                ...
                <div className="accordion-item">
                  ...
                  >
                    <div className="accordion-body">
                      ...
                      <ul>
                        <li>
                          Cloud accounting software offers more flexibility and
                          accessibility than its offline counterpart.
                        </li>
                        <li>
                          The errors that may occur while manually entering the
                          data in offline solutions can be prevented.
                        </li>
                        <li>
