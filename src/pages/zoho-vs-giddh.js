...
const zohoVsGiddh = () => {
  ...
  return (
    <>
      <div className="giddh-vs-zoho">
        <section className="container-fluid giddh-vs-zoho__banner">
          <div className="container">
            <div className="row align-items-center">
              <div className="col-lg-6 col-md-12 order-0 justify-content-center">
                <div className="banner-content">
                  <h1 className="banner-content__title">Zoho Books vs GIDDH</h1>
                  </div>
                  <p className="col-light banner-content__description">
                    Zoho Books and Giddh are two accounting software options
                    with powerful features that can cater to the needs of most
        ...
        <section className="container giddh-vs-zoho__compare-wrapper">
          ...
          <div className="comparing-table-container">
            ...
            <table className="table table-bordered table-custom-border">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    Unlimited company sharing feature is available in all plan
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td>Multiple GSTIN support in single branch in all plan</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td>
                    Need to purchase Zoho books and Zoho inventory separately to
                ...
                <tr>
                  ...
                  <td>
                    Provides an adjustment feature, but it is limited to certain
                    vouchers.
                  </td>
                  <td>
            ...
            <table className="table table-bordered table-custom-border">
              <tbody>
                <tr>
                  <th colspan="2" className="text-center bg-light">Pricing</th>
                </tr>
                <tr>
                  <td>
                    Offers free plan, and paid plans are 749/mo, 1499/mo,
                ...
                <tr>                  
                  <th colspan="2" className="text-center bg-light">Features</th>
                </tr>
                <tr>
                  <td>
                    Upgrading to a higher plan unlocks additional features.
                ...
                <tr>                  
                  <th colspan="2" className="text-center bg-light">Easy search</th>
                </tr>
                <tr>
                  <td>Not available</td>
                  <td>Provides Universal Search feature (Ctrl G/Cmmd G)</td>
                ...
                <tr>                  
                  <th colspan="2" className="text-center bg-light">Multiple companies support</th>
                </tr>
                <tr>
                  <td>Need to purchase plan separately for each company</td>
                  <td>
                ...
                <tr>                  
                  <th colspan="2" className="text-center bg-light">Company sharing</th>
                </tr>
                <tr>
                  <td>
                    Company sharing is limited based on the plan you choose.
                ...
                <tr>                  
                  <th colspan="2" className="text-center bg-light">Branch Support</th>
                </tr>
                <tr>
                  <td>Limited branch creation</td>
                  <td>Unlimited branch creation</td>
                ...
                <tr>                  
                  <th colspan="2" className="text-center bg-light">GSTIN Support</th>
                </tr>
                <tr>
                  <td>Limited as per the plan</td>
                  <td>Multiple GSTIN support in single branch in all plan</td>
                ...
                <tr>                  
                  <th colspan="2" className="text-center bg-light">Warehouse Support</th>
                </tr>
                <tr>
                  <td>Limited warehouse creation</td>
                  <td>Unlimited warehouse creation</td>
                ...
                <tr>                  
                  <th colspan="2" className="text-center bg-light">Inventory Management</th>
                </tr>
                <tr>
                  <td>
                    Need to purchase Zoho books and Zoho inventory separately to
                ...
                <tr>                  
                  <th colspan="2" className="text-center bg-light">Customer & Vendor creation</th>
                </tr>
                <tr>
                  <td>Limited</td>
                  <td>Unlimited</td>
                ...
                <tr>                  
                  <th colspan="2" className="text-center bg-light">Year Locking </th>
                </tr>
                <tr>
                  <td>Doesn't provides year locking</td>
                  <td>
                ...
                <tr>                  
                  <th colspan="2" className="text-center bg-light">Adjustment feature</th>
                </tr>
                <tr>
                  <td>
                    Provides an adjustment feature, but it is limited to certain
                ...
                <tr>                  
                  <th colspan="2" className="text-center bg-light">Entry System</th>
                </tr>
                <tr>
                  <td>Only Voucher based entry system</td>
                  <td>Ledger & Voucher based entry system</td>
                ...
                <tr>                  
                  <th colspan="2" className="text-center bg-light">Auto Paid feature</th>
                </tr>
                <tr>
                  <td>Not available</td>
                  <td>Auto adjustment of voucher with only one setting.</td>
