                  ...
                  <div className="container">
                    <div className="row">
                      <div className="col-12">
                        <label htmlFor="name" className="pb-3">Name <span className="col-danger">*</span></label>
                        <div className="mb-3">
                          <input
                            autoComplete="name"
                            type="email"
                      ...
                      <div className="col-12">
                        <label htmlFor="email" className="pb-3">Email <span className="col-danger">*</span></label>
                        <div className="mb-3">
                          <input
                            autoComplete="email"
                            type="email"
                      ...
                      <div className="col-12 ">
                        <div className="row">
                        <label htmlFor="mobileNo" className="pb-3">Mobile Number <span className="col-danger">*</span></label>
