...
const LoginWithPassword = dynamic(
  () => import("@/components/loginWithPassword"),
  {
    ssr: false,
  }
);
...
const v2Login = (path) => {
  ...
  const [showLoginWithPasswordModal, setShowLoginWithPasswordModal] =
    useState(false);
      ...
      <section className="entry d-flex">
        ...
        <div className="entry__right_section col-xl-9 col-lg-8 col-md-7 col-sm-12 col-12">
          <div className="container entry__right_section__container">
            ...
            <button
              className="entry__right_section__container__entry_button mb-4 me-0 me-md-3"
              onClick={() => setShowLoginWithPasswordModal(true)}
            >
              Login with password
            </button>
            ...
            {showLoginWithPasswordModal && (
              <LoginWithPassword
                emailLoginInProgress={emailLoginInProgress}
                emailPasswordLoginCallback={initiateEmailPasswordLogin}
                hideLoginWithPasswordModal={() =>
                  setShowLoginWithPasswordModal(false)
                }
              />
            )}
