  ...
  <section id="videoBg" class="pr black-back">
    ...
    <img src="../assets/images/Cloud Icon.svg" alt="" class="sky-one-01">
        <div class="banner_intro features_banner">
              <h1 class="banner_heading">Make sense of your numbers by automatic Financial Reports</h1>
              <p class="banner_sub_heading m-t-20">Financial reports will help in evaluating the strengths and weaknesses of any business, be it a small retail one or a growing e-commerce one.</p>
              <p class="m-t-20">
