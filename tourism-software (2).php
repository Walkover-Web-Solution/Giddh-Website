...
<div id="filling">
    ...
    <div class="col-md-12 mrB3">
	    	<h1>Tourism Business</h1>
            
            <p align="center">Managing a business in the travel sector can be challenging. With Giddh, create professional invoices, keep track of your transactions & easily automate your operations. Maintain reliable accounting whether you own a hotel or travel & tour agency.</p>
	    </div>
    	
        <div class="row">
        
        <h2>Ways Your Tourism Business Can Fly High with Giddh!</h2>
        

<h3>Power of Data, Anywhere-Anytime-Anyone!</h3>

<p>Giddh's cloud based platform allows any third party to quickly identify files that require attention during accounting periods without wasting time. Saving time means saving more money for your tourism business!</p>

<h3>Analyse and Evaluate at One Glance!</h3>

<p>See how things are going with a glance at the comprehensive and visually stunning charts on the Giddh dashboard. Curb your unnecessary expenses and save more to earn more!</p>

<h3>On the Go? Giddh's Got you Covered!</h3>

<p>For the business owners who are always on the move, Giddh's mobile app is an excellent medium to keep track of transactions to help you stay ahead of the curve! </p>
