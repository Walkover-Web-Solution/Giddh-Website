  ...
  <section id="videoBg" class="pr black-back">
    ...
    <img src="../assets/images/Cloud Icon.svg" alt="" class="sky-one-01">
        <div class="banner_intro features_banner">
              <h1 class="banner_heading">Work better together by sharing business insights</h1>
              <p class="banner_sub_heading m-t-20">Allow external accountants & internal team members across different departments to work together seamlessly.</p>
              <p class="m-t-20">
