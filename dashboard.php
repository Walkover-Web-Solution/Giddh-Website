  ...
  <section id="videoBg" class="pr black-back">
    ...
    <img src="../assets/images/Cloud Icon.svg" alt="" class="sky-one-01">
        <div class="banner_intro features_banner">
              <h1 class="banner_heading">Know your business' worth with simple online dashboard</h1>
              <p class="banner_sub_heading m-t-20">Turn your accounting data into business intelligence with Giddh Dashboard.</p>
              <p class="m-t-20">
