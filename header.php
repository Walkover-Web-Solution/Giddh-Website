                ...
                <div class="allmenu">
                    ...
                    <ul class="nav navbar-right head-btn">
                        <li ng-hide="signupPage">
                            ...
                            <a href="http://giddh.com/app/login" class="book-demo btn btn-primary navbar-btn mr-2">Login </a>
                        </li>
                        <li>
                        <a href="http://giddh.com/app/signup" class=" btn btn-primary btn-login">Sign up</a>
